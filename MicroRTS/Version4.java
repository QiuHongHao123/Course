...
public class Version4 extends AbstractionLayerAI{
	...
	public Version4(UnitTypeTable a_utt) {
	        this(a_utt, new AStarPathFinding());
	    }
	public Version4(UnitTypeTable a_utt, PathFinding a_pf) {
	...
	public void workersBehavior(List<Unit> workers,Player p, GameState gs){
        ...
        /*
        if(freeWorkers.size()>=2&&defenceWorkers.size()<=1){
        	Unit u = freeWorkers.remove(0);
