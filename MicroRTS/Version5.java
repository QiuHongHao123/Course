...
public class Version5 extends AbstractionLayerAI{
	...
	public Version5(UnitTypeTable a_utt) {
	        this(a_utt, new AStarPathFinding());
	    }
	public Version5(UnitTypeTable a_utt, PathFinding a_pf) {
	...
	public void workersBehavior(List<Unit> workers,Player p, GameState gs){
        ...
        List<Unit> normalWorkers = new LinkedList<Unit>();
        ...
        // harvest with all the normal workers:
        for (Unit u : normalWorkers) {
        ...
        if(canattack>0){ifdefenced=true;}
    ...
    public void meleeUnitBehavior(Unit u,Player p, GameState gs){
        ...
        if ((RclosestDistance>pgs.getHeight()||closestResource==null))
        {
